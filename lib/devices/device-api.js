...
(() => {
  ...
  class DevicesApi extends CrudApi {
    ...
    manageDevice(device) {
      return this._messageCenter.sendRequest(DevicesApi.REQUESTS.MANAGE, {scopes: null}, device);
    }

    unmanageDevice(device) {
      return this._messageCenter.sendRequest(DevicesApi.REQUESTS.UNMANAGE, {scopes: null}, device);
    }
  }
